...
const Signup = () => {
  ...
  return (
    <>
    <form onSubmit={handleSubmit} w="40%" m="auto" shadow="xl" borderWidth="2px" p={4} >
      <VStack spacing={3}>
         <Input
        type="Number"
        name="current_weight"
...
{/* 🧿🧿 */}
      <a href={url}><FcGoogle/>signup with google </a>
      </Button>
      </VStack>
    </form>
    </>
...
//           BACK
//         </Button>
//         <Button colorScheme="blue" type='submit' onClick={handleStage3}>
//           NEXT
//         </Button>
//         <br />
//         <br />
//         <Button><a href={url}>signup with google</a></Button>
//       </Box>
//     </Box>
//   );
// };
