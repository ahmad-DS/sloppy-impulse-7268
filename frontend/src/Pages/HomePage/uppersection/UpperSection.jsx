                      ...
                      <DrawerContent>
                        ...
                        <DrawerBody>
                          <Select
                            ...
                            w={"20px"}
                          >
                            <option value="option1">iPhone & iPad app</option>
                            <option value="option2">Android app</option>
                            <option value="option3">User Reviews</option>
                            <option value="option4">
                              MyNetDiary vs MyFitnessPal
                            </option>
                          </Select>
                          <Select placeholder="Diets" variant="flushed">
                            <option value="option1">Calorie Counting</option>
                            <option value="option2">Low-Carb</option>
                            <option value="option3">Keto</option>
                            <option value="option3">High-Protein</option>
                            <option value="option3">Mediterranean</option>
                            <option value="option3">Vegetarian</option>
                            <option value="option3">Vegan</option>
                          </Select>
                          <Select placeholder="Library" variant="flushed">
                            <option value="option1">Weight Loss Blog</option>
                            <option value="option2">Diet Library</option>
                            <option value="option3">Dietitian team</option>
                          </Select>
                          <Select placeholder="Food Food" variant="flushed">
                            <option value="option1">Food Search</option>
